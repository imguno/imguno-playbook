...
| Skill | Description |
|-------|-------------|
| [sql-inventory-from-code](skills/sql-inventory-from-code/) | Build a CSV-based SQL query inventory by extracting and normalizing SQL from application source code. Code-only; no DB logs or runtime capture. |
